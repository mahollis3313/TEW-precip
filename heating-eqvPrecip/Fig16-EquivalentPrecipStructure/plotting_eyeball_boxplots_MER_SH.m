%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%% MER SH TEW Accum/Avg LH (2001-2020) %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
clear; close all; 

folder = '/home/c770m986/MATLAB_scripts/a_manuscript_code/new_analysis/MER/fixingMER_VintegLH/IMERG_period/eyeballs700/';
filelist1 = dir([folder 'SH_TEW_accumavgLH_*.mat']);
filelist2 = dir([folder 'SH_TEW_latlon_counter_*.mat']);
...
var_name = strcat(folder,'SH_TEW_accumavgLH.mat');
save(var_name,'LH_accum_avg_clim')

var_name1 = strcat(folder,'SH_TEW_avgLH.mat');
save(var_name1,'LHavg_clim')

var_name2 = strcat(folder,'SH_TEW_counter_ALL.mat');
...
close all; clear;
folder = '/home/c770m986/MATLAB_scripts/a_manuscript_code/new_analysis/MER/fixingMER_VintegLH/IMERG_period/eyeballs700/';
load(strcat(folder,'SH_TEW_avgLH.mat'));
...
print('-f1','SH_700waves_eqvrain_eyeball_v2-15int','-dpng')